	...
	foreach ($related_posts as $related_post ){
		...
		if ((!$wp_rp["wp_rp_thumbnail"])||($wp_rp["wp_rp_thumbnail"] && $wp_rp["wp_rp_thumbnail_text"])){
			...
			if ($wp_rp["wp_rp_date"]){
				...
				$output .= '<span class="right date">'.mysql2date($dateformat, $related_post->post_date) . " </span> ";
			}
...
?>
	...
	?>
		...
		<h1><?php _e("Related Posts Settings",'wp_related_posts');?></h1>
        ...
        <table class="form-table">
		  ...
		  <tr valign="top">
            ...
            <td>
				...
				<?php
				$wp_rp_title_tag_array = array('h1','h2','h3','p','div');
